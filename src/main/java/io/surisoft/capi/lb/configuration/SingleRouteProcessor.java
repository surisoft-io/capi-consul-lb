...
public class SingleRouteProcessor extends RouteBuilder {
    ...
    public SingleRouteProcessor(CamelContext camelContext, Api api, RouteUtils routeUtils, String routeId, StickySessionCacheManager stickySessionCacheManager) {
        super(camelContext);
        this.api = api;
